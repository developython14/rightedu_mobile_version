...
class homemod extends StatefulWidget {
  const homemod({Key? key}) : super(key: key);

  @override
  State<homemod> createState() => _homemodState();
}

class _homemodState extends State<homemod> {
